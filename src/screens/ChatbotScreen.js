...
const ChatbotScreen = () => {
  ...
  const sendMessage = async () => {
    ...
    // Make sure UI updates before starting animation
    setTimeout(() => {
      animateNewMessage();
    ...
    try {
      ...
      // Add bot response to state with a small delay to ensure animations complete
      setTimeout(() => {
...
const styles = StyleSheet.create({
  ...
  inputContainer: {
    ...
    borderColor: '#E5E7EB',
    backgroundColor: '#FFFFFF',
    marginBottom: Platform.OS === 'ios' ? 0 : 75,
  },
  inputRow: {
    flexDirection: 'row',
    alignItems: 'flex-end',
...
// Web-specific CSS for typing animation
if (Platform.OS === 'web') {
